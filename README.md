...
- **Чтение данных из JSON, CSV и Excel файлов**
...
### 1. Поиск по описанию с регулярными выражениями
```python
from processing import filter_by_description
...
result = filter_by_description(transactions, 'перевод|оплата')
